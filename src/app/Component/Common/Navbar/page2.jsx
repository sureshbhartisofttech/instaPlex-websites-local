...
const logo = "/Assests/client_logo/logo.png";
...
const DropdownItem = ({ icon, title, description }) => (
  <div className="flex items-start space-x-3 group cursor-pointer">
    <div className="p-2 bg-blue-100 rounded-full flex items-center justify-center text-blue-600">
      {icon}
    </div>
    <div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center cursor-pointer">
              <Link href="/" title="InstaPlex Solutions" className="flex items-center">
                <Image
                  ...
                  priority
                />
                <span className="ml-2 font-bold text-xl lg:text-2xl text-gray-800">
                  InstaPlex
                </span>
              </Link>
            </div>
            ...
            <div className="hidden md:flex space-x-8">
              <Link
                href="/"
                className={`${scrolled ? 'text-gray-700 hover:text-black' : 'text-gray-700 hover:text-gray-200'} font-medium`}
              >
                Home
              </Link>
              <DropdownMenu
            ...
            <div className="hidden md:flex items-center space-x-4">
              <button
                ...
                className="bg-[#0040df] text-white font-bold py-2 px-8 rounded-lg text-xl transition-all duration-200 transform hover:scale-105 shadow-lg"
              >
                Let's Connect
              </button>
            </div>
          ...
          {isOpen && (
            <div className="md:hidden w-full space-y-2 pt-2 px-3 pb-4 bg-white rounded-lg mt-2 shadow-lg backdrop-blur-lg z-50">
              <div className="border-b border-gray-200 py-2 mb-4">
                {/* <Link
                  href="/"
                  className={`block w-full text-left font-semibold ${scrolled ? 'text-gray-700' : 'text-gray-700'}`}
                ...
                {activeDropdown === 'mobile-platform' && (
                  <div className="py-2 px-4 space-y-2 mt-2 max-h-64 overflow-y-auto">
                    ...
                    <a href="#" className="block py-1">InstaMonitoring</a>
              ...
              <button
                onClick={handleConnectClick}
                className="w-full bg-[#0040df] text-white py-2 rounded-lg hover:bg-purple-700 mt-4"
              >
                Let's Connect
              </button>
            </div>
